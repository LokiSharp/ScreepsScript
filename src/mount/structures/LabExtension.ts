import { BOOST_RESOURCE, LAB_STATE, ROOM_TRANSFER_TASK, labTarget, reactionSource } from "setting";
...
export default class LabExtension extends StructureLab {
  public work(): void {
    ...
    if (this.id in this.room.memory.lab.outLab)
      this.room.memory.lab.outLab[this.id] = this.store[this.mineralType] || 0;
  }
