 ...
 * @param amount 要追加的数量
 */
export function orderExtend(orderId: string, amount: number): string {
 ...
 */
export function seeres(resourceName: ResourceConstant): string {
  // 根据资源不同选择不同的查询目标
 ...
 * @param amount 发送数量
 */
export function give(roomName: string, resourceType: ResourceConstant, amount: number): string {
 ...
 */
export function hail(content = "", toPublic = true): string {
 ...
 * @param roomName 房间名
 */
export function base(roomName: string): string {
