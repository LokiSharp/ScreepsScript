...
import { updateStructure } from "@/modules/room/shortcut/updateStructure";
 ...
 * 越靠前建造优先级越高
 */
const BUILD_PRIORITY = [STRUCTURE_SPAWN, STRUCTURE_EXTENSION, STRUCTURE_TOWER, STRUCTURE_LINK, STRUCTURE_STORAGE];
 ...
 * 将放置挂起队列里的工地
 */
export const manageConstruction = function (): void {
  planSite();
  handleCompleteSite();
};
 ...
 * 向队列里新增建造任务
 */
export const addConstructionSite = function (sites: ConstructionPos[]): void {
